...
module ForwardingUnit(readRegister1_1, readRegister2_1, RegWrite_2,
	...
	// Forwarding for compare operands for BEQ
	...
	// Forwarding for sw read register
	always@(MemtoReg_3 or MemWrite_1 or MemtoReg_2 or readRegister2_1
			or writeRegister_3 or RegWrite_3 or MemtoReg_2 or RegWrite_2)
	if(RegWrite_2 && !MemtoReg_2 && MemWrite_1 && writeRegister_2 != 0
		&& readRegister2_1 == writeRegister_2)
		ForwardRB <= 2'b10;
	else if(RegWrite_3 && !MemtoReg_3 && MemWrite_1 && writeRegister_3 != 0
		&& readRegister2_1 == writeRegister_3)
		ForwardRB <= 2'b11;
	else if(RegWrite_3 && MemtoReg_3 && MemWrite_1 && writeRegister_3 != 0
		&& readRegister2_1 == writeRegister_3)
		ForwardRB <= 2'b01;
